...
//toUpperCase() --> is use to convert the string into uppercase but all these happens in copy of actual name 
...
const newstring = gameName.substring(0,4) // it can't include the end index of range and substring() me negative value ni diya jata agr diya gya to bhi wo index 0 se hi start hoga
