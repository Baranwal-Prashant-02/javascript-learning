...
Symbols must be wrapped in [] to be used as keys.
*/
...
const JsUser = {
    ...
    //javaScript treats property names as strings by default; square brackets tell it to compute the key instead of treating it literally.
    age: 18,
    location: "Jaipur",
...
//console.log(JsUser.full name)  //showing error because we never access  such type object("string") names by using this
...
console.log(JsUser.email) // value got update to "day@gmail.com"

console.log("-----------------------------------------------")


const Ratnesh = {   //const sirf variable ko reassign hone se rokta hai 
...
Ratan.greetingTwo = function(){
    console.log(`Hello JS user, ${this.name1}`); // here this is use to access the actual object on which we work on(or perform manupulation)
}
