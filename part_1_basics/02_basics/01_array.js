...
console.log("B : ", myArray);  //B :  [ 0, 2, 4, 6, 8 ] //slice() does NOT change original array


const myn2 = myArray.splice(1, 3) //// remove 3 elements starting from index 1

console.log(myn2);  //[ 2, 4, 6 ]
console.log("C : ", myArray);   //C :  [ 0, 8 ]  // splice changes the original array

 //slice (1,4) only extract the value from array(start from index 1 and end on 3, never include last index of range) and also never change the original array
 // but splice (1,4) extract the value from array(// remove 4 elements starting from index 1) and change the original array
